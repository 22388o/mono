 ...
 */
contract PORTAL is ERC20, ERC20Burnable, ERC20Permit {
     ...
     */
    constructor(address _PortalFoundation) ERC20("PORTAL", "xPORT") ERC20Permit("PORTAL") {
    ...
    function unlockTokens(address _user, uint256 _amount) public {
        ...
        if (msg.sender != owner) { // owner can unlock anytime but not users
