...
export const SendFunds = () => {
  ...
  if(sendingProcess === 3 || sendingProcess === 4 || sendingProcess === 5) 
    return <MyModal open={modalOpen}>
      <Grid container direction='column' spacing={2}>
        ...
        { selAsset.isNFT ? nftAssetContainer() : <Grid item container direction='column' className={styles.borderContainer}>
  ...
  if(sendingProcess === 1.5) 
    return <CollectiblesModal open={modalOpen} handleClose={onClickClose} handleItemClick={onNftItemClick} />
};
